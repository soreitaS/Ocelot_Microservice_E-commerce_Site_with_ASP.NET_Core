...
using MultiShop.WebUI.Services.StatisticServices.CatalogStatisticService;
...
namespace MultiShop.WebUI.Areas.Admin.Controllers
{
    ...
    public class StatisticController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var getActiveCommentTotal=await _commentService.GetActiveCommentCount();
            var getPassiveCommentTotal =await _commentService.GetPassiveCommentCount();
            ...
            ViewBag.getActiveCommentTotal = getActiveCommentTotal;
            ViewBag.getPassiveCommentTotal = getPassiveCommentTotal;
